...
class DeepTrackFlowLoader(DeepTrackLoaderBase):
    def __init__(self, root, pretransforms=[], posttransforms=[], target_transform=[]):
        super(DeepTrackFlowLoader, self).__init__(root, pretransforms, posttransforms, target_transform)
    ...
    def from_index(self, index):
        ...
        return sample, [pose_labels, optical_flow.astype(np.float32).T]
