...
import glfw
from deep_6dof_tracking.data.glew import *
...
class ModelRenderer:
    ...
    def setup_attributes(self):
        ...
        self.uniform_locations = {
            ...
            'lightA_specular': glGetUniformLocation(self.shader_program, 'lightA.specular'),
            ...
            'material_shininess': glGetUniformLocation(self.shader_program, 'material.shininess')
        }

        glUniform1f(self.uniform_locations["material_shininess"], 0.7)

        glUniform3f(self.uniform_locations['lightA_direction'], -1, -1, 1)
        glUniform3f(self.uniform_locations['lightA_diffuse'], 1, 1, 1)
        glUniform3f(self.uniform_locations['lightA_specular'], 1, 1, 1)
    ...
    def render_image(self, view_transform, light_direction=None, light_diffuse=None):
        ...
        glUniformMatrix4fv(self.uniform_locations['view'], 1, GL_FALSE, view_transform.matrix.T)
