...
from deep_6dof_tracking.networks.moddrop3 import ModDrop3
...
class DeepTrackResNetModDrop3(NetworkBase):
    def __init__(self, image_size=150, phase=None, loss_func=nn.MSELoss()):
        super(DeepTrackResNetModDrop3, self).__init__()
        ...
        self.moddropB = ModDrop3([[0, 1, 2], [3]], conv_size=32, conv_stride=2, dropout_proba=0.66, normalize_channels=False)
