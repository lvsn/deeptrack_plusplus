...
class DeepTrackDeepNet(NetworkBase):
    def __init__(self, image_size=150):
        super(DeepTrackDeepNet, self).__init__()
...
if __name__ == '__main__':
    ...
    imsize = 150
    compute_single_test_time(DeepTrackDeepNet, [(4, imsize, imsize), (4, imsize, imsize)],
